...
@Component({
  selector: 'app-mes-informations-coiffeur',
  templateUrl: './mes-informations-coiffeur.page.html',
  styleUrls: ['./mes-informations-coiffeur.page.scss'],
})
export class MesInformationsCoiffeurPage implements OnInit {
